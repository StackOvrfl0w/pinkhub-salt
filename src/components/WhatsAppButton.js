...
export default function WhatsAppButton() {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.5, delay: 1 }} // Delays appearance slightly so it doesn't clutter initial load
      className="fixed bottom-6 right-6 z-50" // Fixed position: Bottom Right
    >
      <Link
        ...
        className="flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-2xl hover:scale-110 hover:bg-[#20bd5a] transition-all duration-300 group"
      >
        {/* WhatsApp SVG Icon */}
        <svg
          viewBox="0 0 24 24"
